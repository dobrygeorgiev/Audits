...
- [Findings](#findings)
  - [High](#high)
    - [\[H-01\] Passwords stored on-chain are visable to anyone, not matter solidity variable visibility](#h-01-passwords-stored-on-chain-are-visable-to-anyone-not-matter-solidity-variable-visibility)
...
### [H-01] Passwords stored on-chain are visable to anyone, not matter solidity variable visibility
