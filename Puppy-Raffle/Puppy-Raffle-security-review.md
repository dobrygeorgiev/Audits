...
- [Findings](#findings)
  - [High](#high)
    - [\[H-01\] Reentrancy attack in `PuppyRaffle::refund` allows entrant to drain contract balance](#h-01-reentrancy-attack-in-puppyrafflerefund-allows-entrant-to-drain-contract-balance)
    - [\[H-02\] Weak randomness in `PuppyRaffle::selectWinner` allows anyone to choose winner](#h-02-weak-randomness-in-puppyraffleselectwinner-allows-anyone-to-choose-winner)
  ...
  - [Medium](#medium)
    - [\[M-01\] Looping through players array to check for duplicates in `PuppyRaffle::enterRaffle` is a potential DoS vector, incrementing gas costs for future entrants](#m-01-looping-through-players-array-to-check-for-duplicates-in-puppyraffleenterraffle-is-a-potential-dos-vector-incrementing-gas-costs-for-future-entrants)
    ...
    - [\[M-04\] Smart Contract wallet raffle winners without a `receive` or a `fallback` will block the start of a new contest](#m-04-smart-contract-wallet-raffle-winners-without-a-receive-or-a-fallback-will-block-the-start-of-a-new-contest)
  - [Informational / Non-Critical](#informational--non-critical)
    - [\[I-01\] Floating pragmas](#i-01-floating-pragmas)
    - [\[I-02\] Magic Numbers](#i-02-magic-numbers)
    - [\[I-03\] Test Coverage](#i-03-test-coverage)
    - [\[I-4\] Zero address validation](#i-4-zero-address-validation)
    - [\[I-05\] \_isActivePlayer is never used and should be removed](#i-05-_isactiveplayer-is-never-used-and-should-be-removed)
    - [\[I-06\] Unchanged variables should be constant or immutable](#i-06-unchanged-variables-should-be-constant-or-immutable)
    - [\[I-07\] Potentially erroneous active player index](#i-07-potentially-erroneous-active-player-index)
    - [\[I-08\] Zero address may be erroneously considered an active player](#i-08-zero-address-may-be-erroneously-considered-an-active-player)
...
### [H-01] Reentrancy attack in `PuppyRaffle::refund` allows entrant to drain contract balance
...
### [H-02] Weak randomness in `PuppyRaffle::selectWinner` allows anyone to choose winner
...
### [M-01] Looping through players array to check for duplicates in `PuppyRaffle::enterRaffle` is a potential DoS vector, incrementing gas costs for future entrants
...
### [M-04] Smart Contract wallet raffle winners without a `receive` or a `fallback` will block the start of a new contest
...
### [I-05] _isActivePlayer is never used and should be removed
...
### [I-06] Unchanged variables should be constant or immutable 
...
### [I-07] Potentially erroneous active player index
...
### [I-08] Zero address may be erroneously considered an active player
